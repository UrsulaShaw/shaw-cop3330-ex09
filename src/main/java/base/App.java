...
public class App {
    public static void main(String[] args) {
        ...
        int gallons = (int) Math.ceil(area/conversionRate);

        System.out.println("You will need "+gallons+" gallons of paint to cover "+area+" square feet.");
    }
